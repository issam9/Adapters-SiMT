...
from fairseq.adaptive_sequence_generator import AdaptiveSequenceGenerator
...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        if seq_gen_cls is None:
            ...
            elif self.strategy=='waitk':
                seq_gen_cls = SequenceGenerator
            else:
                seq_gen_cls = AdaptiveSequenceGenerator
    ...
    def inference_step(
        ...
        with torch.no_grad():
            if isinstance(generator, AdaptiveSequenceGenerator):
